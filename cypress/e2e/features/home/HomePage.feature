...
Feature: Validierung der Startseite (Home Page)
    ...
    Scenario Outline: Überprüfung der Navigationslinks im Header
        ...
        Examples:
            ...
            | Products       | /products   | Automation Exercise - All Products                      |
            | Cart           | /view_cart  | Automation Exercise - Checkout                          |
            | Signup / Login | /login      | Automation Exercise - Signup / Login                    |
            | Test Cases     | /test_cases | Automation Practice Website for UI Testing - Test Cases |
            | API Testing    | /api_list   | Automation Practice for API Testing                     |
            | Contact us     | /contact_us | Automation Exercise - Contact Us                        |
    ...
    Scenario: Überprüfung der Produkte und Bilder auf der Startseite
        Then sollte der Bereich "Features Items" sichtbar sein
